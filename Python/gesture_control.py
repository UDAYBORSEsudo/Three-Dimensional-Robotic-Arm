...
"""
 Given one hand's landmarks, compute (base_angle, arm_angle,
gripper_angle).
...
# Compute raw angles
base_target = int(wrist[0] * 180) # horizontal position →
0–180
arm_target = int((1 - wrist[1]) * 180) # vertical position →
invert y
...
self.smoothing * (gripper_target -
self.prev_angles['gripper']))
# Safety limits
